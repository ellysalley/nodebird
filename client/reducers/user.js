  ...
  return produce(state, draft => {
    switch (action.type) {
      ...
      case EDIT_USERNAME_REQUEST: {
        draft.isEditingUsername = true;
        draft.editUsernameErrorReason = '';
        break;
      }
      case EDIT_USERNAME_SUCCESS: {
        draft.isEditingUsername = false;
        draft.me.username = action.data;
        break;
      }
      case EDIT_USERNAME_FAILURE: {
        draft.isEditingUsername = false;
        draft.editUsernameErrorReason = action.error;
        break;
      }
      default: {
        break;
